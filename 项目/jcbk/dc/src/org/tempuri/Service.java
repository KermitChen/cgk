...
@WebServiceClient(name = "Service", 
                  wsdlLocation = "http://100.100.36.201:8080/GdCjg/Service.asmx?wsdl",
...
public class Service extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://100.100.36.201:8080/GdCjg/Service.asmx?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://100.100.36.201:8080/GdCjg/Service.asmx?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
