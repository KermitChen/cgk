 ...
 * 消息推送.
 * @Description: 
 * @ClassName: com.eshop.util.PushMessageUtil
 * @author: Omar(zp)
 * @date: 2014年9月17日 下午8:00:28 
 *
 */
public class PushMessageUtil{
	 ...
	 */
	public static void sendMessageToMul(List<String> userIds,String methodName,String sendMessage) {
          ...
          Browser.withAllSessionsFiltered(new ScriptSessionFilter() {
			...
			public boolean match(ScriptSession session) {
				...
				if(StringUtils.isNotBlank(getSessionUserId)) {
					return StringUtils.equals(getSessionUserId, tempUserId);
				}
				return false;
			}
		}, new Runnable() {
	...
	private static void appendCurrentSession(ScriptBuffer scriptBuffer, String scriptMethodName, Object ...sendMessage) {
		scriptBuffer.appendCall(scriptMethodName, sendMessage);
