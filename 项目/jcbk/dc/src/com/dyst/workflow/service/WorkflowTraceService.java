package com.dyst.workflow.service;
...
public class WorkflowTraceService {
    ...
    public List<Map<String, Object>> traceProcess(String processInstanceId) throws Exception {
        List<Execution> execution = runtimeService.createExecutionQuery().processInstanceId(processInstanceId).list();//执行实例
...
//        }
        ...
        for (ActivityImpl activity : activitiList) {
            ...
            for(Execution e:execution){
            	property = PropertyUtils.getProperty(e, "activityId");
                if (property != null && Tools.isNotEmpty(e.getParentId())) {
	                activityId = property.toString();
	                if (id.equals(activityId) && !activity.isScope()) {
...
//        vars.put("任务所属角色", roles);
    ...
    public String findKeyById(String typeCode,String id) {
    	return workflowDao.findKeyById(typeCode,id);
    }
