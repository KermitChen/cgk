...
/**
 * FalseDelete entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "FALSE_DELETE", catalog = "dc")
public class FalseDelete implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5774870922065967395L;
	private Integer id;
	...
	/** full constructor */
	public FalseDelete(Integer jpid, String pno, String pname, Date time,
