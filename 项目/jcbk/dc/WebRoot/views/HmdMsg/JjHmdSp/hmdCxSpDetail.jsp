			...
			<table id="tableForm">
				<tr>
					...
					<td class="tdInput">
						...
						<c:forEach items= "${cllxlist }" var="c">
				...
				<tr>
					...
					<td class="tdInput">
						<input class="inputClass" type="text" name="superAreaNo" id="superAreaNo" value="${hmdDetail.sqrdw }">
					</td>
