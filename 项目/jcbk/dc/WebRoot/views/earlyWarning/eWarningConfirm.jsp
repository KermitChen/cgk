...
<html>
						...
						<fieldset style="-moz-border-radius:8px;border:#D2691E 1px solid;">
							<legend style="color:#333; font-weight:bold; font-size: large; margin-left: 30px;">确认信息</legend>
						   	<div class="slider_body">
				                ...
				                <div class="slider_selected_right" style="">
				                    <div class="img_wrap">
				                        <div class="select_wrap select_input_null">
				                            <input id="qrrjh" name="qrrjh" type="text" class="slider_input" readonly="readonly" value="<%=userObj.getLoginName()%>"/>
				                        </div>
				                    </div>  
				                </div>
		        			</div>
						   	<div class="slider_body">
				                ...
				                <div class="slider_selected_right" style="">
				                    <div class="img_wrap">
				                        <div class="select_wrap select_input_null">
				                            <input id="qrr" name="qrr" type="text" class="slider_input" readonly="readonly" value="<%=userObj.getUserName()%>"/>
				                        </div>
				                    </div>  
				                </div>
		        			</div>
		        			<div class="slider_body">
				                ...
				                <div class="slider_selected_right" style="">
				                    <div class="img_wrap">
				                        <div class="select_wrap select_input_null">
				                            <input id="bmmc" name="bmmc" type="text" class="slider_input" readonly="readonly" value="<%=userObj.getLskhbmmc()%>"/>
				                        </div>
				                    </div>  
				                </div>
		        			</div>
				                ...
				                <div class="slider_selected_right" style="">
				                    <div class="img_wrap">
				                        <div class="select_wrap input_wrap_select">
				                            <input id="qrrlxdh" name="qrrlxdh" type="text" class="slider_input" value="<%=("91".equals(userObj.getPosition()) ? "075584450516":"") %>" maxlength="20" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/>
		        			...
		        			<div class="slider_body">
								<div class="slider_selected_left">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red;">*</span>确认状态：
								</div>
								<div class="slider_selected_right dropdown dropdowns" onclick="slider(this)">
									<input class="input_select xiala" id="qrztAdd" readonly="readonly" type="text" value="确认无效"/>
									<input type="hidden" id="qrztSelectAdd" name="property" value="2"/>
									<div class="ul">
										<div class="li" data-value="1" onclick="sliders(this);changeBt();">确认有效</div>
										<div class="li" data-value="2" onclick="sliders(this);changeBt();">确认无效</div>
										<div class="li" data-value="3" onclick="sliders(this);changeBt();">已接报需处警</div>
										<div class="li" data-value="4" onclick="sliders(this);changeBt();">已接报无需处警</div>
										<div class="li" data-value="9" onclick="sliders(this);changeBt();">无需确认</div>
									</div>
								</div>
							</div>
							<div class="slider_body">
								<div class="slider_selected_left">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red;">*</span>拦截条件：
								</div>
								<div class="slider_selected_right dropdown dropdowns" onclick="slider(this)">
									<input class="input_select xiala" id="ljtjAdd" readonly="readonly" type="text" value="不具备拦截条件"/>
									<input type="hidden" id="ljtjSelectAdd" name="property" value="0"/>
									<div class="ul">
										<div class="li xiala_div" data-value="0" onclick="sliders(this)">不具备拦截条件</div>
										<div class="li xiala_div" data-value="1" onclick="sliders(this)">具备拦截条件</div>
									</div>
								</div>
							</div>
							<div id="wxjgmsDiv" class="slider_body_textarea">
				                <div class="slider_selected_left">
				                	<span style="color: red;">*</span>确认结果描述：
				                </div>
				                <div class="slider_selected_right">
				                	<textarea name="qrjg" id="qrjg" rows="3" style="width:951px" maxlength="1024"></textarea>
				                </div>
				        	</div>
							<div class="button_div">
								<c:if test="${isSign eq '1' }">
									<input id="yjqrBt" type="button" class="button_blue" value="预警确认" onclick="sign1()">
									<input id="xfzlBt" type="button" class="button_blue" value="下发指令" onclick="sign()" style="display: none;">
								</c:if>
								<c:if test="${isSign eq '0' }">
									<input type="button" class="button_blue" value="预警确认" onclick="sign1()">
								</c:if>
	...
	<script type="text/javascript">
		...
		function sign(){
			...
			$.ajax({
			    url: '${pageContext.request.contextPath}/earlyWarning/sighEW.do',
			    data: {qsid:'${ewRecieve.qsid }', qrzt:$("#qrztSelectAdd").val(), lxdh:$("#qrrlxdh").val(), qrjg:$("#qrjg").val(), ljtj:$("#ljtjSelectAdd").val()},
			    dataType: "json",
			    type: "POST",   //请求方式
			    success: function(data) {
			    	...
			    	data.success == "success" ? parent.layer.msg("签收成功！"):alert("该预警已被其他人员签收！");
					//刷新预警
					parent.refresh();
					
					//直接跳转指令下发
					parent.sendInstruction('${ewRecieve.qsid }');
		...
		function changeBt() {
		    if('${isSign }' == '1' && $("#qrztSelectAdd").val() == "1"){
		    	$("#xfzlBt").show();
		    	$("#yjqrBt").hide();
		    } else if('${isSign }' == '1' && $("#qrztSelectAdd").val() != "1"){
		    	$("#yjqrBt").show();
		    	$("#xfzlBt").hide();
		    }
	  	};
