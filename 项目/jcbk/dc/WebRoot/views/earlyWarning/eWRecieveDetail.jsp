		...
		<div class="content">
	    	<div class="content_wrap" style="width:1150px">
				<dl id="slide" class="kandyTabs">
	    			<dt><span class="tabbtn">预警确认</span></dt>
	    			<dd>
						...
						<fieldset style="-moz-border-radius:8px;border:#D2691E 1px solid;">
							<legend style="color:#333; font-weight:bold; font-size: large; margin-left: 30px;">确认信息</legend>
						   	<div class="slider_body">
				                ...
				                <div class="slider_selected_right" style="">
				                    <div class="img_wrap">
				                        <div class="select_wrap select_input_null">
				                            <input id="qrrjh" name="qrrjh" type="text" class="slider_input" readonly="readonly" value="${ewRecieve.qrrjh }"/>
				                        </div>
				                    </div>  
				                </div>
		        			</div>
						   	<div class="slider_body">
				                ...
				                <div class="slider_selected_right" style="">
				                    <div class="img_wrap">
				                        <div class="select_wrap select_input_null">
				                            <input id="qrr" name="qrr" type="text" class="slider_input" readonly="readonly" value="${ewRecieve.qrr }"/>
				                        </div>
				                    </div>  
				                </div>
		        			</div>
		        			<div class="slider_body">
				                ...
				                <div class="slider_selected_right" style="">
				                    <div class="img_wrap">
				                        <div class="select_wrap select_input_null">
				                            <input id="bmmc" name="bmmc" type="text" class="slider_input" readonly="readonly" value="${ewRecieve.qrdwdmmc }"/>
				                        </div>
				                    </div>  
				                </div>
		        			</div>
		        			<div class="slider_body">
				                ...
				                <div class="slider_selected_right" style="">
				                    <div class="img_wrap">
				                        <div class="select_wrap select_input_null">
				                            <input id="qrrlxdh" name="qrrlxdh" type="text" class="slider_input" maxlength="20" readonly="readonly" value="${ewRecieve.qrdwlxdh }"/>
				                        </div>
				                    </div>  
				                </div>
		        			</div>
							<div class="slider_body">
								<div class="slider_selected_left">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red;visibility: hidden;">*</span>确认状态：</div>
								<div class="slider_selected_right" style="">
									<div class="img_wrap">
										<div class="select_wrap select_input_null">
											<input id="qrztmc" name="qrztmc" type="text" class="slider_input" readonly="readonly" value="${ewRecieve.qrztmc }" />
										</div>
									</div>
								</div>
							</div>
							<div class="slider_body">
								<div class="slider_selected_left">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red;visibility: hidden;">*</span>拦截条件：</div>
								<div class="slider_selected_right" style="">
									<div class="img_wrap">
										<div class="select_wrap select_input_null">
											<input id="ljtj" name="ljtj" type="text" class="slider_input" readonly="readonly" value="<c:if test="${ewRecieve.jyljtj eq '0' }">不具备拦截条件</c:if><c:if test="${ewRecieve.jyljtj eq '1' }">具备拦截条件</c:if>" />
										</div>
									</div>
								</div>
							</div>
							<div class="slider_body">
								<div class="slider_selected_left">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red;visibility: hidden;">*</span>确认时间：</div>
								<div class="slider_selected_right" style="">
									<div class="img_wrap">
										<div class="select_wrap select_input_null">
											<input id="arsj" name="arsj" type="text" class="slider_input" readonly="readonly" value="${ewRecieve.qrsj }" />
										</div>
									</div>
								</div>
							</div>
							<div id="wxjgmsDiv" class="slider_body_textarea">
				                <div class="slider_selected_left">
				                	<span style="color: red;visibility: hidden;">*</span>确认结果描述：
				                </div>
				                <div class="slider_selected_right">
				                	<textarea name="qrjg" id="qrjg" rows="3" style="width:951px" readonly="readonly" maxlength="1024">${ewRecieve.qrjg }</textarea>
				                </div>
				        	</div>
						</fieldset>
					</dd>
					...
					<c:if test="${!empty instruction }">
						<dt><span class="tabbtn">指令签收</span></dt>
						<dd>
							<fieldset style="-moz-border-radius:8px;border:#D2691E 1px solid;">
								...
								<div class="slider_body">
									...
									<div class="slider_selected_right" style="">
										<div class="img_wrap">
											<div class="select_wrap select_input_null">
												<input id="zlxfrmc" name="zlxfrmc" type="text" class="slider_input" readonly="readonly" value="${instruction.zlxfrmc }" />
											</div>
										</div>
									</div>
								</div>
								<div class="slider_body">
									...
									<div class="slider_selected_right" style="">
										<div class="img_wrap">
											<div class="select_wrap select_input_null">
												<input id="zlxfbmmc" name="zlxfbmmc" type="text" class="slider_input" readonly="readonly" value="${instruction.zlxfbmmc }" />
											</div>
										</div>
									</div>
								</div>
								<div class="slider_body">
									...
									<div class="slider_selected_right" style="">
										<div class="img_wrap">
											<div class="select_wrap select_input_null">
												<input id="jqjb" name="jqjb" type="text" class="slider_input" readonly="readonly" value="${instruction.jqjb }" />
											</div>
										</div>
									</div>
								</div>
								<div class="slider_body">
									...
									<div class="slider_selected_right" style="">
										<div class="img_wrap">
											<div class="select_wrap select_input_null">
												<input id="xdzlfs" name="xdzlfs" type="text" class="slider_input" readonly="readonly" value="${instruction.zlfs }" />
											</div>
										</div>
									</div>
								</div>
								<div class="slider_body">
									...
									<div class="slider_selected_right" style="">
										<div class="img_wrap">
											<div class="select_wrap select_input_null">
												<input id="xfsj" name="xfsj" type="text" class="slider_input" readonly="readonly" value="<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${instruction.xfsj }"/>" />
											</div>
										</div>
									</div>
								</div>
								<div class="slider_body_textarea">
									...
									<div class="slider_selected_right">
										<textarea name="yanr" id="yanr" rows="3" style="width:951px" readonly="readonly">${instruction.yanr }</textarea>
									</div>
								</div>
							</fieldset>
							<c:if test="${!empty instructionSignList }">
								<fieldset style="-moz-border-radius:8px;border:#D2691E 1px solid;">
									<legend style="color:#333; font-weight:bold; font-size: large; margin-left: 30px;">指令签收情况</legend>
									<div class="pg_result">
										<table>
											<thead>
												<tr>
													<td width="10%" align="center">序号</td>
													<td width="20%" align="center">签收部门</td>
													...
													<td width="25%" align="center">签收结果描述</td>
												</tr>
											</thead>
											<tbody>
												<c:forEach var="inSign" items="${instructionSignList }" varStatus="status">
													<tr <c:if test="${inSign.qszt eq '0'}">style="color: red;"</c:if>>
														<td>${status.index+1}</td>
														<td>${inSign.zlbmmc}</td>
														<td>${inSign.qsztmc}</td>
														<td>${inSign.qsrmc}</td>
														<td>${inSign.qsrlxdh }</td>
														<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${inSign.qssj }"/></td>
														<td>${inSign.qsms }</td>
													</tr>
												</c:forEach>
											</tbody>
					...
					<c:if test="${!empty instructionSignList }">
						<dt><span class="tabbtn">指令反馈</span></dt>
						<dd>
							<fieldset style="-moz-border-radius:8px;border:#D2691E 1px solid;">
								<legend style="color:#333; font-weight:bold; font-size: large; margin-left: 30px;">指令反馈情况</legend>
								<div class="pg_result">
									<table>
										<thead>
											<tr>
												...
												<td width="5%" align="center">反馈状态</td>
												<td width="5%" align="center">反馈人</td>
										...
										<tbody>
											<c:forEach var="inSign" items="${instructionSignList }" varStatus="status">
												<tr <c:if test="${inSign.fkzt eq '0'}">style="color: red;"</c:if>>
													<td>${status.index+1}</td>
													<td>${inSign.zlbmmc}</td>
													<td>${inSign.fkztmc}</td>
													<td>${inSign.fkrmc}</td>
	...
	<script type="text/javascript">
		$(function(){
			...
			for(var i=0;i < dic.length;i++){
				...
				} else if(dic[i].typeCode == "BKJB" && '${instruction.jqjb }' == dic[i].typeSerialNo){
					$("#jqjb").val(dic[i].typeDesc);
				} else if(dic[i].typeCode == "XDZLFS" && '${instruction.zlfs }' == dic[i].typeSerialNo){
					$("#xdzlfs").val(dic[i].typeDesc);
				}
			}
