...
<html lang="zh-CN">
	...
	<body>
		<table>
			...
			<tbody>
				<%
					List<DisReceive> bkDisReceiveList = (List<DisReceive>)request.getAttribute("bkDisReceiveList");
					List<Dictionary> dicList = (List<Dictionary>)request.getAttribute("dicList");
					for(int i=0;i < bkDisReceiveList.size();i++){
						DisReceive disReceive = bkDisReceiveList.get(i);
				%>
						<tr>
							<td><%=i+1 %></td>
