...
<body>
		...
		<div id="divBody">
			<table id="tableForm">
				<tr>
					...
					<td class="tdInput">
						<input class="inputClass" type="text" name="id" id="id"/>
					</td>
					<td class="tdError">
						<label class="errorClass" id="idError"></label>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input class="inputClass" type="text" name="showOrder" id="showOrder">
					</td>
					<td class="tdError">
				...
				<tr>
					...
					<td>
						<input class="inputClass" type="text" name="level" id="level">
					</td>
					<td class="tdError">
    ...
    <script type="text/javascript">
		...
		function doSubmit(){
			...
			if(!validateName() || !validateShowOrder() || !validateLevel() || !validateId()){
				return;
			}
			var location = (window.location+'').split('/');  
			var basePath = location[0]+'//'+location[2]+'/'+location[3];
			...
			$.ajax({
				...
				dataType : "json",
				url: basePath + "/bkdj/add.do",//请求的action路径
				error: function () {//请求失败处理函数
