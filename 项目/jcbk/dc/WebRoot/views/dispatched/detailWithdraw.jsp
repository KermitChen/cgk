    	...
    	<div class="content_wrap">
	        ...
	        <div class="slider_body">
	            ...
	            <div class="slider_selected_right dropdown dropdowns" onclick="slider(this)">
	                <input class="input_select xiala" id="csys" type="text" readonly="readonly" value="==请选择=="/>
	        ...
	        <div id="bkfw_div" class="slider_body">
				<div class="slider_selected_left">
	        ...
	        <fieldset style="-moz-border-radius:8px;border:#D2691E 1px solid;">
				<legend style=" color:#333; font-weight:bold; font-size: large; margin-left: 30px;">撤控信息</legend>
		        <div class="slider_body">
					<div class="slider_selected_left">
						<span>撤控人联系电话：</span>
					</div>
				...
				<div class="slider_body_textarea" style="height:160px;">
					<div class="slider_selected_left">
						<span>撤控原因描述<span style="color: red">*</span>：</span>
					</div>
					<div class="slider_selected_right">
						<textarea name="ckyyms" id="ckyyms" rows="6" style="width:951px" readonly="readonly">${withdraw.ckyyms }</textarea>
					</div>
				</div>
	        </fieldset>
