	...
	<div class="content">
		<div class="content_wrap">
			<form name="form" action="" method="post">
				...
				<div id="button_array" class="clear_both">
...
<script type="text/javascript">
	...
	var list_url = "dispatched/disReceive.do";
	//搜索..按钮
	function doSearch() {
	...
	//签收
	function deal(id){
		var url = "${pageContext.request.contextPath}/dispatched/loadDisReceive.do?id="+id;
	    layer.open({
	           type: 2,
	           title: "布控撤控签收",
	           shadeClose: false,
