...
<body>
	...
	<div id="divTitle">
		<span id="spanTitle">重点车辆查询</span>
	</div>
    <div class="content" style="height: 700px">
    	<div class="content_wrap">
    	 	<form id="form1" name="form1" action="<%=basePath%>clcx/importantQuery.do" method="post">
	                ...
	                <div class="slider_selected_right">
	                    <div class="img_wrap">
	                        <div class="select_wrap input_wrap_select">
	                            <input id="cphid" name="hphm" type="text" class="slider_input" readonly="readonly" onclick="chooseImportantVehicle();" value="${hphm }">
	                            <a class="empty" href="javascript:chooseImportantVehicle()"></a>
	                        </div>
	                    </div>  
	                </div>
	        	</div>
	...
	<script type="text/javascript">
		var list_url = "<%=basePath%>clcx/importantQuery.do";
		//根据页号查询
		...
		//选择重点车辆
		function chooseImportantVehicle(){
			var location = (window.location+'').split('/');  
			var basePath = location[0]+'//'+location[2]+'/'+location[3];  
			var url = basePath + "/clcx/importantChoose.do";
			layer.open({
				  type: 2,
				  title:'选择重点车辆',
				  area:['600px','450px'],
