function graphTrace(options) {
    ...
    $('#changeImg').live('click', function() {
        ...
        $('<div/>', {
            ...
            html: "<img src='" + getURL() + '/workflow/process/trace/auto.do?executionId=' + opts.pid + "' />"
	...
	$('#diagram-viewer').live('click', function() {
		...
		var url = getURL() + '/common/diagram-viewer/index.html?processDefinitionId=' + opts.pdid + '&processInstanceId=' + opts.pid;
    ...
    // 获取图片资源
    var imageUrl = getURL() + "/workflow/resource/process-instance.do?pid=" + opts.pid + "&type=image";
    $.getJSON(getURL() + '/workflow/process/trace.do?pId=' + opts.pid, function(infos) {
