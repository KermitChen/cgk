window.BMAP_AUTHENTIC_KEY = ""; (function() {
    ...
    x.ea.bM = /webkit/i.test(navigator.userAgent);
    ...
    x.D.ha = function(a) {
        ...
        if (a.getBoundingClientRect) {
            ...
            if (c.opera > 0 || c.bM > 0 && d(a, "position") == "absolute") e.top = e.top - b.body.offsetTop;
    ...
    /(\d+\.\d)?(?:\.\d)?\s+safari\/?(\d+\.\d+)?/i.test(ja) && !/chrome/i.test(ja) && (x.ea.zN = +(RegExp.$1 || RegExp.$2));
    ...
    x.platform.VL = /macintosh/i.test(navigator.userAgent);
    x.platform.M2 = /MicroMessenger/i.test(navigator.userAgent);
    x.platform.cM = /windows/i.test(navigator.userAgent);
    ...
    x.KK = function() {
        function a(a) {
            document.addEventListener && (this.element = a, this.NK = this.zk ? "touchstart": "mousedown", this.kD = this.zk ? "touchmove": "mousemove", this.jD = this.zk ? "touchend": "mouseup", this.rh = q, this.bu = this.au = 0, this.element.addEventListener(this.NK, this, q), ha.M(this.element, "mousedown", s()), this.handleEvent(p))
        }
        a.prototype = {
    ...
    function Ja(a, b) {
        if (a = x.$(a)) {
            ...
            c.K.te && (this.SX(c.K.te.controls), this.PL(c.K.te.geotableId));
            ...
            b.enableDeepZoom === q && (c.K.IK = b.enableDeepZoom);
            var d = c.K.SU;
            if (G()) for (var e = 0,
    ...
    x.extend(Ja.prototype, {
        ...
        ik: function(a, b, c, d) {
            ...
            f = this.we,
            g = o;
            c && H.UL(c) && (this.ef = new H(c.lng, c.lat), g = q);
        ...
        ui: function(a) {
            a instanceof H && (this.pc = this.we.Jm(a, this.Vb), this.ef = H.UL(a) ? new H(a.lng, a.lat) : this.we.qh(this.pc, this.Vb))
        },
        yg: function(a, b) {
            a = Math.round(a) || 0;
            b = Math.round(b) || 0;
        ...
        Bg: function(a) {
            if (this.Hb !== a) {
                ...
                b.Ka = c;
                b.Hb = a;
                this.dispatchEvent(b); (a === Wa || a === Pa) && Oa(xa)
            }
        },
        Vf: function(a) {
            var b = this;
        ...
        Cd: function(a, b) {
            ...
            ua = G() ? Za.Fi.ok(z.qJ ? 102 : 101) : Za.Fi.ok(1);
            ua.cu();
            ua.iz = +new Date;
        ...
        m3: function(a, b) {
            var c = map.Vb;
            this.Hb === Na && c && (a.x += this.offsetX, a.y += this.offsetY, db.fK(a, this, b))
        },
        Gd: function(a) {
        ...
        Nt: function(a) {
            ...
            if (a) {
                ...
                G() && x.ea.zN ? setTimeout(function() {
                    b.K.te = a;
                    b.dispatchEvent(new N("onsetcustomstyles", a))
                },
                50) : (this.K.te = a, this.dispatchEvent(new N("onsetcustomstyles", a)), this.PL(b.K.te.geotableId));
                var c = {
                    style: a.style
                };
        ...
        SX: function(a) {
            ...
            var b = this,
            c;
            for (c in this.controls) b.nN(b.controls[c]);
            a = a || [];
            x.jc.Eb(a,
            function(a) {
                b.lw(b.controls[a])
...
//                    ob.src = z.Hc + "images/blank.gif?" + a.src
    ...
    z.tg = function(a, b) {
        ...
        default:
            d = z.url.domain[a],
            "[object Array]" == Object.prototype.toString.call(d) ? (c = [], x.jc.Eb(d,
            function(a, d) {
                c[d] = z.url.proto + a + "/" + b
    ...
    x.ea.rg ? (x.extend(F, {
        ...
        Wb: "-moz-grab",
        Ed: "-moz-grabbing"
    }), x.platform.cM && (F.fontFamily = "arial,simsun,sans-serif")) : x.ea.YJ || x.ea.zN ? x.extend(F, {
    ...
    function Sa() {
        return ! (!x.platform.cM && !x.platform.VL && !x.platform.iY)
    }
    function $a() {
            ...
            if (!C || !C.Ho) {
                ...
                O = function(a) {
                    ...
                    if ("define" == a || "require" == a) {
                        ...
                        c = !c ? "#" + E++:c;
                        d = oa[c] = oa[c] || {};
                        d.Ho || (d.name = c, d.iZ = e, d.nK = f, "define" == a && (d.MV = o), g(d))
    ...
    z.Ij = z.alog || s();
    function Pb(a, b) {
    	if (/^http/.test(a)){//拦截在线访问
//    		console.log("拦截地图在线访问$$$$$"+a);
    		return;
    	}
        if (b) {
        	a='{"error":0}';
    ...
    var Qb = {
        ...
        style: "44zsko",
        tile: "v0n0pe",
        vectordrawlib: "zweida",
        newvectordrawlib: "tkmbbw",
        groundoverlay: "4uemhu",
        pointcollection: "te1s0a",
        marker: "j24nk2",
        symbol: "afadbr",
        canvablepath: "coxx3d",
        vmlcontext: "oobylp",
        markeranimation: "jaa1h3",
        poly: "c3yuod",
        draw: "i0m5sw",
        drawbysvg: "1cz2km",
        drawbyvml: "y3zmjv",
        ...
        citylistcontrol: "zkdixj",
        scommon: "czdsn3",
        local: "nnqhvi",
        route: "byvwvy",
        othersearch: "5m0qyr",
        mapclick: "ovea3m",
        buslinesearch: "faoxr3",
        hotspot: "1iegsz",
        autocomplete: "j4c3d3",
        coordtrans: "4k1bs0",
    ...
    x.object.extend(I, {
        ...
        gL: function() {
            var a = "drawbysvg",
            b = "canvablepath",
            c = z.qJ ? "newvectordrawlib": "vectordrawlib";
        ...
        s3: {},
        aG: {
            NP: z.ma + "getmodules?v=2.0&t=20140707",
            oU: 5E3
        },
        zC: q,
        Nd: {
                ...
                if (d.Bd == this.Fj.hG) {
                    ...
                    e.zC == q && (e.zC = o, setTimeout(function() {
                        for (var a = [], b = 0, c = e.Nd.En.length; b < c; b++) {
                            var d = e.Nd.En[b],
                            l = "";
                            ha.Gy.WJ(d) ? l = ha.Gy.get(d) : (l = "", a.push(d + "_" + Qb[d]));
                            e.Nd.Pv.push({
                                EM: d,
                                EE: l
                            })
                        ...
                        e.Nd.En.length = 0;
                        console.log(a);
                        0 == a.length ? e.MK() : Pb("common/js/map/getmodules.js")
                        //ԭ����0 == a.length ? e.MK() : Pb(e.aG.NP + "&mod=" + a.join(","))
                    },
                    1));
                    d.Bd = this.Fj.wP
                }
        ...
        cK: function(a) {
            if (a && this.gL()[a]) for (var a = this.gL()[a], b = 0; b < a.length; b++) this.cK(a[b]),
            this.Nd.rl[a[b]] || this.kN(a[b])
        },
        kN: function(a) {
        ...
        gb: function(a) {
            ...
            this.Nd.rl[a].Bd = this.Fj.hG, this.Nd.rl[a].Pu = []);
            return this.Nd.rl[a]
        },
        remove: function(a) {
            delete this.gb(a)
        ...
        gV: function(a, b) {
            ...
            d = o,
            e = 0,
            f = c.length; e < f; e++)"" == c[e].EE && (c[e].EM == a ? c[e].EE = b: d = q);
            d && this.MK()
        },
        MK: function() {
            for (var a = this.Nd.Pv,
            b = 0,
            c = a.length; b < c; b++) this.oZ(a[b].EM, a[b].EE);
            this.Nd.Pv.length = 0
        }
    });
    function Q(a, b) {
    ...
    function hb(a, b) {
        a && (this.Kb = a, this.ba = "spot" + hb.ba++, b = b || {},
        this.Vg = b.text || "", this.wv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.jJ = b.userData || p, this.Qh = b.minZoom || p, this.Cf = b.maxZoom || p)
    }
    hb.ba = 0;
    ...
    jc.prototype.draw = function(a) {
        if (z.cq) {
            ...
            "canvas" === b.Lb && b.canvas && b.RG(b.canvas.getContext("2d"))
        }
    ...
    x.extend(lc.prototype, {
        Hj: function() {
            ...
            "none" != a.borderColor && c.push("border:" + a.Nx + "px " + a.pY + " " + a.iM + ";");
    ...
    function oc(a, b, c, d) {
        a && (this.Bv = {},
        this.SK = d ? !!d: q, this.Vc = [], this.l_ = a instanceof nc ? a: p, this.wI = b === j ? o: !!(b.indexOf("%") + 1), this.$j = isNaN(parseFloat(b)) ? 1 : this.wI ? parseFloat(b) / 100 : parseFloat(b), this.xI = !!(c.indexOf("%") + 1), this.repeat = c != j ? this.xI ? parseFloat(c) / 100 : parseFloat(c) : 0)
    };
    function pc(a, b) {
        x.lang.Ba.call(this);
        this.content = a;
    ...
    x.extend(pc.prototype, {
        ...
        HN: function(a) { ! a && 0 != a || (isNaN(a) || 0 > a) || (0 != a && (220 > a && (a = 220), 730 < a && (a = 730)), this.z.maxWidth = a)
        },
        Dc: function(a) {
            this.z.title = a
        },
    ...
    x.extend(Cc.prototype, {
        ...
        a_: function(a, b, c, d) {
            ...
            k = this.wg[g];
            k && k.Gb ? (vb(k.Gb, b), d && (d = new Q(a[0], a[1]), f = this.map.K.te ? this.map.K.te.style: "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Fc(k, d)), k.loaded ? this.vf() : Gc(k,
            function() {
                e.vf()
            })) : (k = this.fj[g]) && k.Gb ? (c.Pb.insertBefore(k.Gb, c.Pb.lastChild), this.wg[g] = k, vb(k.Gb, b), d && (d = new Q(a[0], a[1]), f = this.map.K.te ? this.map.K.te.style: "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Fc(k, d)), k.loaded ? this.vf() : Gc(k,
            function() {
                e.vf()
            })) : (k = i * Math.pow(2, f.qm() - a[2]), new H(a[0] * k, a[1] * k), d = new Q(a[0], a[1]), f = this.map.K.te ? this.map.K.te.style: "normal", d = c.getTilesUrl(d, a[2], f), k = new Hc(this, d, b, a, c), Gc(k,
            function() {
                e.vf()
            }), k.$n(), this.wg[g] = k)
        },
        ...
        Tf: function(a) {
            var b = this;
            if (b.map.ta() == Na) I.load("coordtrans",
            function() {
                b.map.Vb || (b.map.Vb = Na.tk(b.map.$g), b.map.Bw = Na.cL(b.map.Vb));
                b.dI()
            },
            o);
            else {
        ...
        dI: function(a) {
            for (var b = this.Km.concat(this.Wf), c = b.length, d = 0; d < c; d++) {
                ...
                if (!e.UH && !(e.mp && !this.map.Ub() || e.aM && this.map.Ub())) {
                    var l = this.map,
                    m = l.ta(),
                    f = m.bp(),
                    i = l.Ka,
                    ...
                    for (C in y) {
                        var A = y[C],
                        B = A.info; (B[2] != n || B[2] == n && (k > B[0] || g <= B[0] || f > B[1] || m <= B[1])) && this.Cx(A)
                    }
        ...
        Nt: function(a) {
            var b = this.map.ta();
            if (!this.map.Ub() && (a ? this.map.K.i_ = a: a = this.map.K.i_, a)) for (var c = p,
    ...
    mb.prototype.getTilesUrl = function(a, b) {
        ...
        d = a.y,
        e = this.nc,
        c = Nc[Math.abs(c + d) % Nc.length] + "/image?grids=" + c + "_" + d + "_" + b + "&q=" + e.Wm + "&tags=" + e.eu + "&filter=" + e.filter + "&sortby=" + e.Ey + "&ak=" + this.nc.Sl + "&age=" + e.sw + "&page_size=" + e.iN + "&format=" + e.q_;
    ...
    Vc = new Dc;
    Vc.dO = [z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[0] + "/resource/mappic/", z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[1] + "/resource/mappic/", z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[2] + "/resource/mappic/", z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[3] + "/resource/mappic/"];
    Vc.getTilesUrl = function(a, b) {
        var c = a.x,
        d = a.y,
        e = 256 * Math.pow(2, 20 - b),
        d = Math.round((9998336 - e * d) / e) - 1;
        return url = this.dO[Math.abs(c + d) % this.dO.length] + this.map.Vb + "/" + this.map.Bw + "/3/lv" + (21 - b) + "/" + c + "," + d + ".jpg"
    };
    var Na = new Qc("\u4e09\u7ef4", Vc, {
        tips: "\u663e\u793a\u4e09\u7ef4\u5730\u56fe",
        minZoom: 15,
    ...
    function V(a, b) {
        ...
        this.k = {
            ...
            VM: b.onMarkersSet || s(),
            UM: b.onInfoHtmlSet || s(),
            XM: b.onResultsHtmlSet || s(),
            TM: b.onGetBusListComplete || s(),
            SM: b.onGetBusLineComplete || s(),
            QM: b.onBusListHtmlSet || s(),
            PM: b.onBusLineHtmlSet || s(),
    ...
    var Zc = {
        ...
        ab: function(a, b, c, d, e) {
            ...
            d = d || "";
            b = c && c.xO ? Eb(b, encodeURI) : Eb(b, encodeURIComponent);
            this.nG = c && c.Fs ? c.sN ? c.sN: z.qp: z.Hc;
...
//						console.log("d:"+d);
    ...
    qd.Cn = 100;
    qd.cP = [0, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0, 1, 1, 1];
    ...
    sd.pP = " \u73af\u5c9b \u65e0\u5c5e\u6027\u9053\u8def \u4e3b\u8def \u9ad8\u901f\u8fde\u63a5\u8def \u4ea4\u53c9\u70b9\u5185\u8def\u6bb5 \u8fde\u63a5\u9053\u8def \u505c\u8f66\u573a\u5185\u90e8\u9053\u8def \u670d\u52a1\u533a\u5185\u90e8\u9053\u8def \u6865 \u6b65\u884c\u8857 \u8f85\u8def \u531d\u9053 \u5168\u5c01\u95ed\u9053\u8def \u672a\u5b9a\u4e49\u4ea4\u901a\u533a\u57df POI\u8fde\u63a5\u8def \u96a7\u9053 \u6b65\u884c\u9053 \u516c\u4ea4\u4e13\u7528\u9053 \u63d0\u524d\u53f3\u8f6c\u9053".split(" ");
    x.sa(sd, pd, "DWRoute");
    ...
    x.extend(Xd, {
                ...
                function(b) {
                    ...
                    function(b) {
                        if (b && b.id) {
                            ...
                            k = e.nL(f, m, 0, Xd.zu.width, Xd.zu.height);
        ...
        nL: function(a, b, c, d, e) {
            ...
            return (Xd.Du + "?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}").replace(/\{(.*?)\}/g,
            function(a, b) {
                return f[b]
            })
        }
    ...
    Be = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
    function(a) {
    ...
    function Ee(a, b) {
        ...
        c.refresh();
        c.ca(ve, window);
        c.ca(we); ! se && "none" != c.options.KO && (c.ca("DOMMouseScroll"), c.ca("mousewheel"));
        ...
        this.options.xx && (Event.prototype.stopImmediatePropagation || (document.body.removeEventListener = function(a, b, c) {
            ...
            a === "click" ? d.call(document.body, a, b.FL || b, c) : d.call(document.body, a, b, c)
        },
        document.body.addEventListener = function(a, b, c) {
            var d = Node.prototype.addEventListener;
            a === "click" ? d.call(document.body, a, b.FL || (b.FL = function(a) {
                a.bZ || b(a)
    ...
    Ee.prototype = {
        ...
        Nv: function(a) {
            ...
            d;
            if (this.enabled) {
                this.options.OM && this.options.OM.call(this, a); (this.options.Bi || this.options.zoom) && this.fJ(0);
                ...
                if (this.options.Sx && (this.options.Uk ? (c = getComputedStyle(this.Nb, p)[he].replace(/[^0-9\-.,]/g, "").split(","), d = +(c[12] || c[4]), c = +(c[13] || c[5])) : (d = +getComputedStyle(this.Nb, p).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Nb, p).top.replace(/[^0-9-]/g, "")), d != this.x || c != this.y)) this.options.Bi ? this.Vd(Ae) : Ce(this.SB),
                this.Aj = [],
                this.xr(d, c),
        ...
        QS: function(a) {
            ...
            if (this.options.zoom && se && 1 < a.touches.length) e = Zd.abs(a.touches[0].pageX - a.touches[1].pageX),
            ...
            this.options.aN && this.options.aN.call(this, a);
                ...
                6 > this.ew && 6 > this.fw || (this.options.xE && (this.ew > this.fw + 5 ? (f = this.y, d = 0) : this.fw > this.ew + 5 && (e = this.x, c = 0)), this.rh = o, this.xr(e, f), this.DC = 0 < c ? -1 : 0 > c ? 1 : 0, this.EC = 0 < d ? -1 : 0 > d ? 1 : 0, 300 < g - this.startTime && (this.startTime = g, this.au = this.x, this.bu = this.y), this.options.YM && this.options.YM.call(this, a))
            }
        },
        $u: function(a) {
            if (! (se && 0 !== a.touches.length)) {
                ...
                b.options.up && b.options.up.call(b, a);
                    ...
                    if (b.rh) {
                        ...
                        f.Aa || g.Aa ? (c = Zd.max(Zd.max(f.time, g.time), 10), b.options.Yt && (f = d - b.gw, g = e - b.hw, Zd.abs(f) < b.options.Dy && Zd.abs(g) < b.options.Dy ? b.scrollTo(b.gw, b.hw, 200) : (f = b.XI(d, e), d = f.x, e = f.y, c = Zd.max(f.time, c))), b.scrollTo(Zd.round(d), Zd.round(e), c)) : b.options.Yt ? (f = d - b.gw, g = e - b.hw, Zd.abs(f) < b.options.Dy && Zd.abs(g) < b.options.Dy ? b.scrollTo(b.gw, b.hw, 200) : (f = b.XI(b.x, b.y), (f.x != b.x || f.y != b.y) && b.scrollTo(f.x, f.y, f.time))) : b.io(200)
                    } else {
                        if (se) if (b.xK && b.options.zoom) clearTimeout(b.xK),
                        b.xK = p,
        ...
        io: function(a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.rh && (this.rh = q, this.options.Yx && this.options.Yx.call(this)), this.mi && this.options.Bx && ("webkit" == ae && (this.CL.style[ne] = "300ms"), this.CL.style.opacity = "0"), this.Ci && this.options.Bx)"webkit" == ae && (this.CO.style[ne] = "300ms"),
        ...
        xB: function() {
            ...
            f,
            g;
            a.Vl || (a.Aj.length ? (e = a.Aj.shift(), e.x == b && e.y == c && (e.time = 0), a.Vl = o, a.rh = o, a.options.Bi) ? (a.fJ(e.time), a.xr(e.x, e.y), a.Vl = q, e.time ? a.ca(Ae) : a.io(0)) : (g = function() {
                var i = Date.now(),
                k;
                if (i >= d + e.time) {
                    a.xr(e.x, e.y);
        ...
        refresh: function() {
            ...
            this.EC = this.DC = 0;
            this.options.WM && this.options.WM.call(this);
    ...
    x.extend(Fe.prototype, {
        ...
        ly: function(a, b) {
            if (b || !this.bk[this.Yc] || !(this.bk[this.Yc].panoId == a && 3 !== this.bk[this.Yc].recoType)) {
                var c = this,
                d = this.wH(a); ! b && -1 !== d && this.bk[d] && 3 !== this.bk[d].recoType ? this.Jp(d) : this.lX(function(a) {
                    for (var b = {},
                    d, i, k = q,
                    l = [], m = 0, n = a.length; m < n; m++) d = a[m].catlog,
                    i = a[m].floor,
                    j !== d && ("" === d && j !== i ? (k = o, b[i] || (b[i] = []), b[i].push(a[m])) : (b[He[d]] || (b[He[d]] = []), b[He[d]].push(a[m])));
        ...
        Dl: function(a) {
            ...
            a = this.wH(this.P.Yb(), this.N0); - 1 !== a && this.Jp(a)
        },
        $W: function(a) {
            for (var b = "",
            c, d = 0,
    ...
    S(Ke, {
        ...
        getPanes: function() {
            return {
                ...
                floatShadow: this.Td.TK,
                labelPane: this.Td.tE,
                markerPane: this.Td.wM,
                markerShadow: this.Td.xM,
                mapPane: this.Td.ot,
                vertexPane: this.Td.GO
            }
        },
        addTileLayer: Ke.Yg,
